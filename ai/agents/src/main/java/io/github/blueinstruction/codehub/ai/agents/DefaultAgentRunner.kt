...
import io.github.blueinstruction.codehub.ai.gateway.AiGateway
import io.github.blueinstruction.codehub.ai.gateway.ChatChunk
import io.github.blueinstruction.codehub.ai.gateway.ChatMessage
import io.github.blueinstruction.codehub.ai.gateway.ChatRequest
import io.github.blueinstruction.codehub.ai.gateway.ToolCall
...
import io.github.blueinstruction.codehub.ai.context.ContextRetriever
import io.github.blueinstruction.codehub.core.diagnostics.DiagnosticSink
import io.github.blueinstruction.codehub.core.permissions.AgentPolicy
import io.github.blueinstruction.codehub.core.permissions.PermissionDecider
import io.github.blueinstruction.codehub.core.permissions.PermissionLevel
import io.github.blueinstruction.codehub.core.permissions.ToolRequest
...
class DefaultAgentRunner @Inject constructor(
    ...
    private suspend fun handleToolCall(session: AgentSession, toolCall: ToolCall) {
        ...
        val result = runCatching { tool.invoke(invocation) }.getOrElse {
            io.github.blueinstruction.codehub.ai.tools.ToolResult(
